				...
				<div className={'footer__info'}>
					...
					<p><a href={'https://developer.themoviedb.org/docs'}>All data provided by <span>TMDB-API</span></a>
						<a href={'https://www.themoviedb.org/'}>
							<img className={'TMDB__logo'} src={'https://www.themoviedb.org/assets/2/v4/logos/v2/blue_short-8e7b30f73a4020692ccca9c88bafe5dcb6f8a62a4c6bc55cd9ba82bb2cd95f6c.svg'} alt="The Movie DB . org" /></a>
					</p>
